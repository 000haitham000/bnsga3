...
import extreme_zdt2_2016a_lib.ExtremeZdt2Optimizer;

/**
 *
 * @author Haitham
 */
public class Zdt2ExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeZdt2Optimizer extremeOptimizer = null;

    public Zdt2ExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeZdt2Optimizer();
        }
    }
