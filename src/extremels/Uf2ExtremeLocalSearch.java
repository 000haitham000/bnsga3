 ...
 * @author Haitham
 */
public class Uf2ExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeUf2Optimizer extremeOptimizer = null;

    public Uf2ExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeUf2Optimizer();
        }
    }
