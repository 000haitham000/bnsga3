...
import extreme_dtlz1_2016a_lib.ExtremeDtlz1Optimizer;

/**
 *
 * @author Haitham
 */
public class Dtlz1ExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeDtlz1Optimizer extremeOptimizer = null;

    public Dtlz1ExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeDtlz1Optimizer();
        }
    }
