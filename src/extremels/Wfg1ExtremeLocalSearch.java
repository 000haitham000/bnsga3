...
import extreme_wfg1_2017b_lib.ExtremeWfg1Optimizer;

/**
 *
 * @author Haitham
 */
public class Wfg1ExtremeLocalSearch implements ExtremeLocalSearch {

    int k; // number of position related parameters (variables)
    
    // The object representing the MATLAB script
    static ExtremeWfg1Optimizer extremeOptimizer = null;

    public Wfg1ExtremeLocalSearch(int k) throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeWfg1Optimizer();
        }
        this.k = k;
    }
