...
//import extreme_osy_2016a_lib.ExtremeOsyOptimizer;
import extreme_osy_2017b_lib.ExtremeOsyOptimizer;
 ...
 * @author Haitham
 */
public class OsyExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeOsyOptimizer extremeOptimizer = null;

    public OsyExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeOsyOptimizer();
        }
    }
