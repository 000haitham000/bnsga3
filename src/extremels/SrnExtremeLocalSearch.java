...
import extreme_srn_2016a_lib.ExtremeSrnOptimizer;

/**
 *
 * @author Haitham
 */
public class SrnExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeSrnOptimizer extremeOptimizer = null;

    public SrnExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeSrnOptimizer();
        }
    }
