...
import extreme_zdt6_2016a_lib.ExtremeZdt6Optimizer;

/**
 *
 * @author Haitham
 */
public class Zdt6ExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeZdt6Optimizer extremeOptimizer = null;

    public Zdt6ExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeZdt6Optimizer();
        }
    }
