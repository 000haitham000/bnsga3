...
import extreme_zdt4_2016a_lib.ExtremeZdt4Optimizer;

/**
 *
 * @author Haitham
 */
public class Zdt4ExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeZdt4Optimizer extremeOptimizer = null;

    public Zdt4ExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeZdt4Optimizer();
        }
    }
