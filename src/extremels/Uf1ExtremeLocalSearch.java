 ...
 * @author Haitham
 */
public class Uf1ExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeUf1Optimizer extremeOptimizer = null;

    public Uf1ExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeUf1Optimizer();
        }
    }
