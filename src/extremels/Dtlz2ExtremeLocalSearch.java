...
import extreme_dtlz2_2016a_lib.ExtremeDtlz2Optimizer;

/**
 *
 * @author Haitham
 */
public class Dtlz2ExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeDtlz2Optimizer extremeOptimizer = null;

    public Dtlz2ExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeDtlz2Optimizer();
        }
    }
