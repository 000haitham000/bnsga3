...
import extreme_bnh_2016a_lib.ExtremeBnhOptimizer;

/**
 *
 * @author Haitham
 */
public class BnhExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeBnhOptimizer extremeOptimizer = null;

    public BnhExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeBnhOptimizer();
        }
    }
