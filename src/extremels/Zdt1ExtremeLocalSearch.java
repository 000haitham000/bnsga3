...
import extreme_zdt1_2016a_lib.ExtremeZdt1Optimizer;

/**
 *
 * @author Haitham
 */
public class Zdt1ExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeZdt1Optimizer extremeOptimizer = null;

    public Zdt1ExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeZdt1Optimizer();
        }
    }
