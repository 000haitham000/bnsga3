...
import extreme_tnk_2016a_lib.ExtremeTnkOptimizer;

/**
 *
 * @author Haitham
 */
public class TnkExtremeLocalSearch implements ExtremeLocalSearch {

    // The object representing the MATLAB script
    static ExtremeTnkOptimizer extremeOptimizer = null;

    public TnkExtremeLocalSearch() throws MWException {
        ...
        if(extremeOptimizer == null) {
            extremeOptimizer = new ExtremeTnkOptimizer();
        }
    }
