 ...
 * @author Haitham
 */
public class BnhKKTPMCalculator extends KKTPM_CalculatorImpl {

    public BnhKKTPMCalculator() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/bnh.xml"));
            } catch (Throwable ex) {
                Logger.getLogger(BnhKKTPMCalculator.class.getName()).log(Level.SEVERE, null, ex);
