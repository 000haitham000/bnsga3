 ...
 * @author Haitham
 */
public class Uf2KKTPMCalculator extends KKTPM_CalculatorImpl {

    public Uf2KKTPMCalculator() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/Dropbox/KKTPM/Java KKTPM/XML/uf2.xml"));
                problem.setConstant("pi", Math.PI);
            } catch (Throwable ex) {
                Logger.getLogger(Uf2KKTPMCalculator.class.getName()).log(Level.SEVERE, null, ex);
