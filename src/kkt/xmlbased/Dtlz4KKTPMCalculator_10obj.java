 ...
 * @author Haitham
 */
public class Dtlz4KKTPMCalculator_10obj extends KKTPM_CalculatorImpl {

    public Dtlz4KKTPMCalculator_10obj() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/dtlz4_10obj_modified.xml"));
                problem.setConstant("pi", Math.PI);
                problem.setConstant("alpha", GeneralDTLZ4Evaluator.ALPHA);
                problem.setConstant("D", GeneralDTLZ4Evaluator.D); // Th additional distance parameter added to increase the difficulty of convergence
            } catch (Throwable ex) {
                Logger.getLogger(Dtlz4KKTPMCalculator_10obj.class.getName()).log(Level.SEVERE, null, ex);
