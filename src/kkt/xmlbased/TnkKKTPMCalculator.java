 ...
 * @author Haitham
 */
public class TnkKKTPMCalculator extends KKTPM_CalculatorImpl {

    public TnkKKTPMCalculator() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/tnk.xml"));
            } catch (Throwable ex) {
