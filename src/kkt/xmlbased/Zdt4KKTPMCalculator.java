 ...
 * @author Haitham
 */
public class Zdt4KKTPMCalculator extends KKTPM_CalculatorImpl {

    public Zdt4KKTPMCalculator() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/zdt4.xml"));
                problem.setConstant("pi", Math.PI);
            } catch (Throwable ex) {
                Logger.getLogger(Zdt4KKTPMCalculator.class.getName()).log(Level.SEVERE, null, ex);
