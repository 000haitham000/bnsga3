 ...
 * @author Haitham
 */
public class Dtlz2KKTPMCalculator_03obj extends KKTPM_CalculatorImpl {

    public Dtlz2KKTPMCalculator_03obj() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/dtlz2_3obj.xml"));
                problem.setConstant("pi", Math.PI);
            } catch (Throwable ex) {
                Logger.getLogger(Dtlz2KKTPMCalculator_03obj.class.getName()).log(Level.SEVERE, null, ex);
