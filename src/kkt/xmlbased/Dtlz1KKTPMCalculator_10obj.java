 ...
 * @author Haitham
 */
public class Dtlz1KKTPMCalculator_10obj extends KKTPM_CalculatorImpl {

    public Dtlz1KKTPMCalculator_10obj() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/dtlz1_10obj.xml"));
                problem.setConstant("pi", Math.PI);
            } catch (Throwable ex) {
                Logger.getLogger(Dtlz1KKTPMCalculator_10obj.class.getName()).log(Level.SEVERE, null, ex);
