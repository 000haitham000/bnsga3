 ...
 * @author Haitham
 */
public class Zdt1KKTPMCalculator extends KKTPM_CalculatorImpl {

    public Zdt1KKTPMCalculator() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/zdt1.xml"));
            } catch (Throwable ex) {
                Logger.getLogger(Zdt1KKTPMCalculator.class.getName()).log(Level.SEVERE, null, ex);
