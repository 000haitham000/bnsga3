 ...
 * @author Haitham
 */
public class Zdt3KKTPMCalculator extends KKTPM_CalculatorImpl {

    public Zdt3KKTPMCalculator() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/zdt3.xml"));
                problem.setConstant("pi", Math.PI);
            } catch (Throwable ex) {
                Logger.getLogger(Zdt3KKTPMCalculator.class.getName()).log(Level.SEVERE, null, ex);
