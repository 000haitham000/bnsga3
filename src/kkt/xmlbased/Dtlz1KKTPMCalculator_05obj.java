 ...
 * @author Haitham
 */
public class Dtlz1KKTPMCalculator_05obj extends KKTPM_CalculatorImpl {

    public Dtlz1KKTPMCalculator_05obj() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/dtlz1_5obj.xml"));
                problem.setConstant("pi", Math.PI);
            } catch (Throwable ex) {
                Logger.getLogger(Dtlz1KKTPMCalculator_05obj.class.getName()).log(Level.SEVERE, null, ex);
