 ...
 * @author Haitham
 */
public class OsyKKTPMCalculatorNumerical extends KKTPM_CalculatorImpl {

    public OsyKKTPMCalculatorNumerical() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/Dropbox/KKTPM/Java KKTPM/XML/osy_no_gradients.xml"));
            } catch (Throwable ex) {
                Logger.getLogger(OsyKKTPMCalculatorNumerical.class.getName()).log(Level.SEVERE, null, ex);
