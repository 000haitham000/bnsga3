 ...
 * @author Haitham
 */
public class SrnKKTPMCalculator extends KKTPM_CalculatorImpl {

    public SrnKKTPMCalculator() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/srn.xml"));
            } catch (Throwable ex) {
                Logger.getLogger(SrnKKTPMCalculator.class.getName()).log(Level.SEVERE, null, ex);
