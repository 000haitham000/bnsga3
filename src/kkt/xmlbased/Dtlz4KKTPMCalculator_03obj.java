 ...
 * @author Haitham
 */
public class Dtlz4KKTPMCalculator_03obj extends KKTPM_CalculatorImpl {

    public Dtlz4KKTPMCalculator_03obj() {
        ...
        if (problem == null) {
            try {
                problem = XMLParser.readXML(new File("E:/KKTPM/Java KKTPM/XML/dtlz4_3obj_modified.xml"));
                ...
                Logger.getLogger(Dtlz4KKTPMCalculator_03obj.class.getName()).log(Level.SEVERE, null, ex);
