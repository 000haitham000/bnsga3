...
import asf_dtlz1_2016a_lib.AsfDtlz1Optimizer;
 ...
 * @author Haitham
 */
public class DTLZ1_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static AsfDtlz1Optimizer asfDtlz1Optimizer = null;

    public DTLZ1_ASF_Minimizer() throws MWException {
        ...
        if(asfDtlz1Optimizer == null) {
            asfDtlz1Optimizer = new AsfDtlz1Optimizer();
        }
    }
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = asfDtlz1Optimizer.fmincon_dtlz1_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian);
        // Collect outputs
