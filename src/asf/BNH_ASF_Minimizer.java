...
import asf_bnh_2016a_lib.AsfBnhOptimizer;
 ...
 * @author Haitham
 */
public class BNH_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static AsfBnhOptimizer asfBnhOptimizer = null;

    public BNH_ASF_Minimizer() throws MWException {
        ...
        if(asfBnhOptimizer == null) {
            asfBnhOptimizer = new AsfBnhOptimizer();
        }
    }
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = asfBnhOptimizer.fmincon_bnh_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian_displacement_vector);
        // Collect outputs
