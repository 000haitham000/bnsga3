...
import asf_uf4_2017b_lib.AsfUF4Optimizer;
import com.mathworks.toolbox.javabuilder.MWClassID;
import com.mathworks.toolbox.javabuilder.MWException;
import com.mathworks.toolbox.javabuilder.MWNumericArray;
import emo.Individual;
import emo.OptimizationProblem;
import evaluators.UF4Evaluator;
 ...
 * @author Haitham
 */
public class UF4_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static AsfUF4Optimizer asfUf4Optimizer = null;

    public UF4_ASF_Minimizer() throws MWException {
        ...
        if (asfUf4Optimizer == null) {
            asfUf4Optimizer = new AsfUF4Optimizer();
        }
    }
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = asfUf4Optimizer.fmincon_uf4_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian_displacement_vector);
        // Collect outputs
...
//        System.out.format("Individual %s is minimized to %s.%n", Arrays.toString(x0), localSearchOutput.toString());
    ...
    public static void main(String[] args) throws MWException, IOException, XMLStreamException, InvalidOptimizationProblemException {
        // Testing point
        double[] x1 = {0.002, -0.5, 0.77, 0.3, 0.1, 0.96, -0.5, 0.213, 0.3, -0.1, -0.96, -0.5, -0.99, 0.0101, 0.1, -0.99, -1, 1.5, 1.0, 0.0, 0.66, -0.5, 0.8, 0.3, 0.1, -0.96, -0.5, 0.8, 0.3, 1};
        ...
        AsfUF4Optimizer asfUF4Optimizer = new AsfUF4Optimizer();
        // f1
        Object[] f1Result = asfUF4Optimizer.f1(1, point);
        double f1 = ((double[][]) ((MWNumericArray) f1Result[0]).toDoubleArray())[0][0];
        // f2
        Object[] f2Result = asfUF4Optimizer.f2(1, point);
        double f2 = ((double[][]) ((MWNumericArray) f2Result[0]).toDoubleArray())[0][0];

        // Test the Java Code
        URL url = UF4_ASF_Minimizer.class.getResource("../samples/uf4-30.xml");
        OptimizationProblem problem = StaXParser.readProblem(url.openStream());
        UF4Evaluator evaluator = new UF4Evaluator();
