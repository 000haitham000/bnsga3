...
import asf_uf3_2017b_lib.AsfUF3Optimizer;
import com.mathworks.toolbox.javabuilder.MWClassID;
import com.mathworks.toolbox.javabuilder.MWException;
import com.mathworks.toolbox.javabuilder.MWNumericArray;
import emo.Individual;
import emo.OptimizationProblem;
import evaluators.UF3Evaluator;
 ...
 * @author Haitham
 */
public class UF3_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static AsfUF3Optimizer asfUf3Optimizer = null;

    public UF3_ASF_Minimizer() throws MWException {
        ...
        if (asfUf3Optimizer == null) {
            asfUf3Optimizer = new AsfUF3Optimizer();
        }
    }
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = asfUf3Optimizer.fmincon_uf3_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian_displacement_vector);
        // Collect outputs
...
//        System.out.format("Individual %s is minimized to %s.%n", Arrays.toString(x0), localSearchOutput.toString());
    ...
    public static void main(String[] args) throws MWException, IOException, XMLStreamException, InvalidOptimizationProblemException {
        // Testing point
        double[] x1 = {0.002, 0.5, 0.77, 0.3, 0, 0.96, 0.5, 0.213, 0.3, 0.1, 0.96, 0.5, 0.99, 0.0101, 0.1, 0.99, 1, 1.5, 1.0, 0.0, 0.66, 0.5, 0.8, 0.3, 0.1, 0.96, 0.5, 0.8, 0.3, 1};
        ...
        AsfUF3Optimizer asfUF3Optimizer = new AsfUF3Optimizer();
        // f1
        Object[] f1Result = asfUF3Optimizer.f1(1, point);
        double f1 = ((double[][]) ((MWNumericArray) f1Result[0]).toDoubleArray())[0][0];
        // f2
        Object[] f2Result = asfUF3Optimizer.f2(1, point);
        double f2 = ((double[][]) ((MWNumericArray) f2Result[0]).toDoubleArray())[0][0];

        // Test the Java Code
        URL url = UF3_ASF_Minimizer.class.getResource("../samples/uf3-30.xml");
        OptimizationProblem problem = StaXParser.readProblem(url.openStream());
        UF3Evaluator evaluator = new UF3Evaluator();
