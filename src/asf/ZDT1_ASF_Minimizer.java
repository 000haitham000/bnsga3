...
import asf_zdt1_2016a_lib.AsfZdt1Optimizer;
 ...
 * @author Haitham
 */
public class ZDT1_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static AsfZdt1Optimizer asfZdt1Optimizer = null;

    public ZDT1_ASF_Minimizer() throws MWException {
        ...
        if(asfZdt1Optimizer == null) {
            asfZdt1Optimizer = new AsfZdt1Optimizer();
        }
    }
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = asfZdt1Optimizer.fmincon_zdt1_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian_displacement_vector);
        // Collect outputs
