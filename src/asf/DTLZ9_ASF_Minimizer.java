...
import dtlz9_asf.Dtlz9Asf;

/**
 *
 * @author Haitham
 */
public class DTLZ9_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static Dtlz9Asf dtlz9Asf = null;

    public DTLZ9_ASF_Minimizer() throws MWException {
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = dtlz9Asf.fmincon_dtlz9_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian);
        // Collect outputs
