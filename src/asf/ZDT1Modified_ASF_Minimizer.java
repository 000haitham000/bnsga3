...
import zdt1modified_asf.Zdt1modifiedAsf;

/**
 *
 * @author Haitham
 */
public class ZDT1Modified_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static Zdt1modifiedAsf zdt1modifiedAsf = null;

    public ZDT1Modified_ASF_Minimizer() throws MWException {
        ...
        if(zdt1modifiedAsf == null) {
            zdt1modifiedAsf = new Zdt1modifiedAsf();
        }
    }
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = zdt1modifiedAsf.fmincon_zdt1modified_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian_displacement_vector);
        // Collect outputs
