...
import asf_zdt3_2016a_lib.AsfZdt3Optimizer;
 ...
 * @author Haitham
 */
public class ZDT3_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static AsfZdt3Optimizer asfZdt3Optimizer = null;

    public ZDT3_ASF_Minimizer() throws MWException {
        ...
        if(asfZdt3Optimizer == null) {
            asfZdt3Optimizer = new AsfZdt3Optimizer();
        }
    }
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = asfZdt3Optimizer.fmincon_zdt3_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian_displacement_vector);
        // Collect outputs
