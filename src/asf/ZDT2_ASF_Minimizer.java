...
import asf_zdt2_2016a_lib.AsfZdt2Optimizer;
 ...
 * @author Haitham
 */
public class ZDT2_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static AsfZdt2Optimizer asfZdt2Optimizer = null;

    public ZDT2_ASF_Minimizer() throws MWException {
        ...
        if(asfZdt2Optimizer == null) {
            asfZdt2Optimizer = new AsfZdt2Optimizer();
        }
    }
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = asfZdt2Optimizer.fmincon_zdt2_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian_displacement_vector);
        // Collect outputs
