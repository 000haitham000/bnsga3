...
import dtlz8_asf.Dtlz8Asf;

/**
 *
 * @author Haitham
 */
public class DTLZ8_ASF_Minimizer implements ASF_Minimizer {

    // The object representing tha MATLAB script
    static Dtlz8Asf dtlz8Asf = null;

    public DTLZ8_ASF_Minimizer() throws MWException {
    ...
    public LocalSearchOutput minimizeASF(
        ...
        // Call the script
        Object[] result = dtlz8Asf.fmincon_dtlz8_asf_script(3, startingPoint, wVector, maxFunEvals, ideal, intrcpts, utopian);
        // Collect outputs
