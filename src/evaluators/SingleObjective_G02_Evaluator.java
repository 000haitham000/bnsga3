...
public class SingleObjective_G02_Evaluator extends IndividualEvaluator {
    ...
    public void updateIndividualObjectivesAndConstraints(
        ...
        individual.setObjective(0, -1 * Math.abs((cosSum - cosProd) / rootPowerSum));
        ...
        if (problem.constraints != null) {
            ...
            // Reverse constraints (because here we are using >= notation and the paper is using <= notation)
            g[0] = g[0] * -1;
            g[1] = g[1] * -1;
