 ...
 * @author toshiba
 */
public class UF8Evaluator extends IndividualEvaluator {

    public final static double[] NADIR_POINT = {1.0, 1.0, 1.0};
    public final static double[] IDEAL_POINT = {-0.001, -0.001, -0.001};
    ...
    private void calculateObjectives(Individual individual) {
        ...
        CEC2009.UF8(individual.real, f, individual.real.length);
